...
var mapCanvas = document.getElementById("map1");
        var mapOptions = {
          center: new google.maps.LatLng(39.171048, -86.516740),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker = new google.maps.Marker({
			position: new google.maps.LatLng(39.171048, -86.516740)
		});
...
var mapCanvas1 = document.getElementById("map2");
        var mapOptions1 = {
          center: new google.maps.LatLng(39.165077, -86.517420),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker1 = new google.maps.Marker({
			position: new google.maps.LatLng(39.165077, -86.517420)
		});
...
var mapCanvas2 = document.getElementById("map3");
        var mapOptions2 = {
          center: new google.maps.LatLng(39.169132, -86.519561),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker2 = new google.maps.Marker({
			position: new google.maps.LatLng(39.169132, -86.519561)
		});
        ...
        var mapOptions4 = {
          center: new google.maps.LatLng(39.166054, -86.522733),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker4 = new google.maps.Marker({
			position: new google.maps.LatLng(39.166054, -86.522733)
		});
        ...
        var mapOptions5 = {
          center: new google.maps.LatLng(39.164709, -86.524628),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker5 = new google.maps.Marker({
			position: new google.maps.LatLng(39.164709, -86.524628)
		});
        ...
        var mapOptions6 = {
          center: new google.maps.LatLng(39.168933, -86.525274),
          zoom:15,
		  zoomControl: true,
          mapTypeId: google.maps.MapTypeId.ROADMAP
        };
		...
		var marker6 = new google.maps.Marker({
			position: new google.maps.LatLng(39.168933, -86.525274)
		});
...
google.maps.event.addDomListener(window, 'load', function(){
	...
	//var mapDiv1 = document.getElementById('clickit1');
	//google.maps.event.addDomListener(mapDiv1, 'click', initialize);
